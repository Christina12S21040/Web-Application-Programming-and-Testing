...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        do {
            $booking_code = 'BK-' . substr(str_shuffle($characters), 0, 6);
        } while (Booking::where('booking_code', $booking_code)->exists());

        // Set default values using model attributes
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData['payment_method'] = 'Cash'; // Sesuaikan dengan kebutuhan
