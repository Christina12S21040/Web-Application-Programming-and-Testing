...
class ProductController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($request->file('product_image')) {
      ...
      $namaFile = time() . Str::of(pathinfo($file->getClientOriginalName(), PATHINFO_FILENAME))->slug('-') . '.' . $file->getClientOriginalExtension();
      $tujuanFile = 'storage/';
      Image::make($file)->save(public_path($tujuanFile) . '/' . $namaFile);
