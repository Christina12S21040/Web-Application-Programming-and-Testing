...
<head>
  ...
  <link rel="icon" href="{{asset('web-assets/component/logo.png')}}" type="image/x-icon">
  <link rel="shortcut icon" href="{{asset('web-assets/component/logo.png')}}" type="image/x-icon">
