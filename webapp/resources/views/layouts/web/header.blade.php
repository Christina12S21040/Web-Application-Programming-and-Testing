...
<head>
    <style>
        /* Atur font untuk teks "Novi Salon" */
        .logo-name {
            font-family: 'Nama Font Anda', sans-serif;
            font-size: 30px; /* Ukuran font */
            color: #7a633a; /* Warna font (contoh: merah) */
            ...
            <div class="header__for-megamenu p-relative">
                <div class="row align-items-center">
                    ...
                    <div class="header__logo">
                        <a href="#"><img src="{{asset('web-assets/component/logo.png')}}" width="170" alt="logo"></a>
                        <span class="logo-name">Novi Salon</span>
                    </div>
                    </div>
                    <div class="col-xl-6">
