        ...
        <div class="col-md-12">
            ...
            <div>
               <div class="login-main">
                <div><a class="logo text-center" href="{{ url('/') }}"><img class="img-fluid for-light" src="{{asset('web-assets/component/logo.png')}}" width="130" alt="looginpage"><img class="img-fluid for-dark" src="{{asset('assets/images/logo/queen1.jpg')}}" width="130" alt="looginpage"></a></div>
