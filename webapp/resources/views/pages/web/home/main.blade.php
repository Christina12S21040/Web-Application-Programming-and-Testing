               ...
               <div class="row align-items-center">
                  <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-6 col-sm-7">
                        <div class="tpslider__content pt-20">
                            <h2 class="tpslider__title mb-30">Welcome</h2>
                            <p>Think Beauty, Think Us</p>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="tpabout__title-img text-center mb-45">
                           ...
                           <p>Your beauty blinds me becauce it comes from your heart and it is reflected in your eyes.</p>
                        </div>
                     </div>
                  </div>
