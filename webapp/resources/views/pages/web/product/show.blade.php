                                    ...
                                    <div class="product__details">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Novi Salon</h5>
                                        ...
                                        <div class="product__details-stock mb-25">
                                            <ul>
                                                ...
                                                <li>Categories: <span>Novi Salon Products</span></li>
                                            </ul>
                                        </div>
                        ...
                        <div class="tpsidebar__product">
                            ...
                            <div class="tpsidebar__product-item">
                                ...
                                <div class="tpsidebar__product-content">
                                    ...
                                    <a href="{{route('product.index')}}">Novi Products</a>
                                    </span>
